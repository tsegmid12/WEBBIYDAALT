          ...
          <div className="flex items-center gap-4 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-700">
                Хариулсан ({completedQuestions.length})
              </span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 bg-orange-400 rounded"></div>
              <span className="text-gray-700">
                Хариулаагүй ({incompleteQuestions.length})
              </span>
            </div>
              ...
              return (
                ...
                >
                      ...
                      {isCorrect ? (
                        <>
                          ...
                          <span className="text-green-600 font-medium">
                            {answerData.point_earned}/
                            {answerData.point_possible}
                          </span>
                        </>
                      ) : (
                        <>
                          ...
                          <span className="text-red-600 font-medium">
                            {answerData?.point_earned || 0}/
                            {answerData?.point_possible || eq.point}
                          </span>
                        </>
                      )}
                    </div>
                  ...
                  {eq.question.type === "multiple_choice" && (
                    <div className="space-y-2">
                      {eq.question.options?.map((option) => {
                        const selectedAnswers = answerData?.answer || [];
