...
import { Award, CheckCircle, XCircle, Eye, ArrowLeft, RotateCcw } from 'lucide-react';
    ...
    <div className='max-w-4xl mx-auto space-y-6'>
      ...
      <div
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-6'>
          <div className={`rounded-lg p-6 border-4 ${getScoreBgColor(submission.grade_point)}`}>
            <p className='text-sm font-medium text-gray-700 mb-2'>Оноо</p>
            <p className={`text-4xl font-bold ${getScoreColor(submission.grade_point)}`}>
        ...
        <div className='flex items-center justify-center gap-6 mb-6'>
          <div className='flex items-center gap-2 bg-green-50 px-4 py-2 rounded-lg border border-green-200'>
            ...
            <span className='text-gray-700 font-medium'>
              Зөв: <span className='text-green-700 font-bold'>{correctCount}</span>/{totalCount}
            </span>
          </div>
          <div className='flex items-center gap-2 bg-red-50 px-4 py-2 rounded-lg border border-red-200'>
            <XCircle className='text-red-600' size={20} />
            <span className='text-gray-700 font-medium'>
              Буруу: <span className='text-red-700 font-bold'>{totalCount - correctCount}</span>/{totalCount}
            </span>
          </div>
        </div>
