...
const LessonSubmissionsPage = () => {
  ...
  const userSubmission = currentUser?.id
    ? submissions.find((s) => s.user_id === currentUser.id)
    : null;
  ...
  const stats = {
    ...
    average:
      submissions
        .filter((s) => s.grade_point)
        .reduce((acc, s) => acc + s.grade_point, 0) /
      ...
      <div className="relative z-10 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center text-sm mb-6 space-x-2">
            ...
            <Link
              to={`/team2/courses/${course_id}/submissions`}
              className="text-blue-300 hover:text-blue-200 transition-colors"
            >
              {currentCourse?.name}
            </Link>
            ...
            <div className="flex items-start justify-between">
              ...
              {canSubmit && (
                <button
                  onClick={() =>
                    navigate(
                      `/team2/courses/${course_id}/lessons/${lesson_id}/submissions/create`
                    )
                  }
