...
export default function SchoolEdit(){
  ...
  const [photoPreview, setPhotoPreview] = useState("https://images.unsplash.com/photo-1562774053-701939374585?w=800&h=500&fit=crop");
  ...
  return (
    <div className="space-y-4">
      <PageHeader title={`Сургуулийн мэдээлэл засах #${school_id}`} />
      <Card>
        <form className="grid sm:grid-cols-2 gap-4" onSubmit={(e)=>{e.preventDefault(); nav("..");}}>
          <Input label="Сургуулийн нэр" defaultValue="ШУТИС" required />
